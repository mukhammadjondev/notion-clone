...
export const Pricing = () => {
  return (
    <div className="max-w-7xl mx-auto container">
      <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold max-w-2xl">
        One tool for your whole company. Free for teams to try.
      </h2>
      <p className="uppercase opacity-70">TRUSTED BT TEAMS AT</p>
...
const cards = [
  ...
  },
  {
    ...
    price: "8",
    priceId: "price_1ONG58GYLSOXQ9OlISwQ0zWE",
  },
  {
    title: "Business",
    ...
    price: "15",
    priceId: "price_1ONG46GYLSOXQ9Olqoq5DyXd",
  },
]