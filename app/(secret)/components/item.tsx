...
export const Item = ({label, id, level, expanded, onExpand}: ItemProps) => {
  ...
  return (
    <div style={{paddingLeft: level ? `${level * 12 + 12}px` : '12px'}} className="group min-h-[27px] text-sm py-1 pr-3 w-full hover:bg-primary/5 flex items-ceter text-muted-foreground font-medium">
      {!!id && (
